  ...
  const getList = () => {
    api
      ...
      .then((response) => {
        ...
        if (!listData.is_public && (!user || listData.created_by !== user.username)) {
      ...
      <div className="movie-list-container">
        ...
        {list && (
          <>
              ...
              {list.movies.length === 0 ? (
                ...
                list.movies.map((movie) => (
                  <MovieComponent
                    key={movie.id}
                    movie={movie}
                    onRemoveFromList={handleRemoveMovie}
            ...
            <div className="back-button-container-movieList">
              <button onClick={() => navigate(-1)} className="back-button-movieList">
